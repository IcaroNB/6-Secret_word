...
function App() {
  ...
  return (
    <div className='App'>
      ...
      {gameStage === "game" && <GameScreen verifyLetter={verifyLetter} pickedWord={pickedWord} pickedCategory={pickedCategory} letters={letters} guessedLetters={guessedLetters} wrongLetters={wrongLetters} guesses={guesses} score={score}></GameScreen>}
      {gameStage === "end" && <EndScreen newGame={newGame} score={score} pickedWord={pickedWord}></EndScreen>}
    </div>
  );
}
